...
Improvements:
* [SELV3-847](https://openlmis.atlassian.net/browse/SELV3-847) Snapshot the exchange rate onto orders at shipment creation, covering requisition-less orders that skip the order-create hook.
